        ...
        <div className="section_of_sections">
            <label htmlFor="salida" class="title_text">Estoy aquí: </label>
                ...
                <div class="select" id="llegada">
                    <select onChange={(value) => {
                        _useStates.llegada(value.target.value);
                        console.log(en_que_mapa(SetSalidaState, LlegadaState,json_lista_de_salas))

                        SetMapa(en_que_mapa(valores_default.Sala_de_salida,value.target.value,json_lista_de_salas))
                    }}>
