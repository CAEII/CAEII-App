...
import Prueba from './components/prueba';     //esto es una prueba del componente sponsors
  ...
  <div className="App">
    <BrowserRouter>
      <Routes>
        ...
        {/* <Route path="/prueba" element={<Prueba/>}/>    esto es una prueba del componente sponsors */}
      </Routes>
    </BrowserRouter>
